...
import myutil.ExcelParserPlus;
import myutil.XmlParser_online;
...
//	static {
//		XmlParser_online g_xp = new XmlParser_online("test-data/Global.xml");
...
//	
	...
	private void initXml() {// 初始化，把那个数据文件先解析出来
		if (xp == null) {
			xp = new XmlParser_online(filePath);
		}
	}
